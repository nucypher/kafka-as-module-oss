 ...
 * @see DataFileReader
 */
public class GenericDataFileWriter extends DataFileWriter<GenericRecord> {
    private Schema schema;
    private DatumWriter<GenericRecord> dout;
    ...
    public GenericDataFileWriter(DatumWriter<GenericRecord> dout) {
        super(dout);
        this.dout = dout;
    }
     ...
     */
    public DataFileWriter<GenericRecord> setCodec(CodecFactory c) {
        assertNotOpen();
     ...
     *   this DataFileWriter
     */
    public DataFileWriter<GenericRecord> setSyncInterval(int syncInterval) {
    ...
    public DataFileWriter<GenericRecord> create(Schema schema, File file) throws IOException {
        return create(schema, new SyncableFileOutputStream(file), null);
    }

    /** Open a new file for data matching a schema with a random sync. */
    public DataFileWriter<GenericRecord> create(Schema schema, String schemaString, File file) throws IOException {
        return create(schema, schemaString, new SyncableFileOutputStream(file), null);
    }

    /** Open a new file for data matching a schema with a random sync. */
    public DataFileWriter<GenericRecord> create(Schema schema, OutputStream outs)
            throws IOException {
        return create(schema, outs, null);
    }

    /** Open a new file for data matching a schema with a random sync. */
    public DataFileWriter<GenericRecord> create(Schema schema, String schemaString, OutputStream outs)
            throws IOException {
        return create(schema, schemaString, outs, null);
    }

    /** Open a new file for data matching a schema with an explicit sync. */
    public DataFileWriter<GenericRecord> create(Schema schema, OutputStream outs, byte[] sync)
            throws IOException {
        return create(schema, schema.toString(), outs, sync);
    }

    /** Open a new file for data matching a schema with an explicit sync. */
    public DataFileWriter<GenericRecord> create(
            Schema schema, String schemaString, OutputStream outs, byte[] sync)
            throws IOException {
        assertNotOpen();

        this.schema = schema;
        setMetaInternal(DataFileConstants.SCHEMA, schemaString);
        if (sync == null) {
    ...
    public DataFileWriter<GenericRecord> appendTo(File file) throws IOException {
     ...
     */
    public DataFileWriter<GenericRecord> appendTo(SeekableInput in, OutputStream out)
            throws IOException {
        assertNotOpen();
        DataFileReader<GenericRecord> reader =
                new DataFileReader<>(in, new GenericDatumReader<GenericRecord>());
    ...
    private DataFileWriter<GenericRecord> setMetaInternal(String key, byte[] value) {
        assertNotOpen();
        meta.put(key, value);
        return this;
    }

    private DataFileWriter<GenericRecord> setMetaInternal(String key, String value) {
        try {
    ...
    public DataFileWriter<GenericRecord> setMeta(String key, byte[] value) {
    ...
    /** Set a metadata property. */
    public DataFileWriter<GenericRecord> setMeta(String key, String value) {
        try {
    ...
    /** Set a metadata property. */
    public DataFileWriter<GenericRecord> setMeta(String key, long value) {
     ...
     */
    public void append(GenericRecord datum) throws IOException {
        assertOpen();
     ...
     * @throws IOException
     */
    public void appendAllFrom(DataFileStream<GenericRecord> otherFile, boolean recompress) throws IOException {
        assertOpen();
